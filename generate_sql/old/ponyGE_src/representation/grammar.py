...
class Grammar(object):
    ...
    def __init__(self, file_name, ramps = 10):
        """
        ...
        self.start_rule, self.codon_size = None, 5#params['CODON_SIZE']
    ...
    def check_permutations(self, ramps):
        """
    ...
    def get_min_ramp_depth(self):
        ...
        max_tree_depth = 10#params['MAX_INIT_TREE_DEPTH']
        size = 100# params['POPULATION_SIZE']
